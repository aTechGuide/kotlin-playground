...
object Nullables {
    ...
    // null = no value
    // Developer daniel = null; // possible in other languages e.g Java
    // val kamran: Developer = null; // not possible in Kotlin
    // NPE
    ...
    val masterYoda: Developer = maybeDeveloper_v2!! // type is now concrete
